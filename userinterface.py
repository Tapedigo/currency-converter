...
while True:
    ...
    if input_of_user == 'quit'.lower() or input_of_user == 'q'.lower():
        break
    else:
        Currency = input("What currency would you like to convert to? (\"USD\" \"AUD\" \"EUR\" etc.) ")
        converter = CurrencyAppCaller.CurrencyCoverter('https://v6.exchangerate-api.com/v6/af370279909b3852fbc7252f/latest/USD')
